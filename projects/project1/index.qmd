...
Imagine that I manage the homepage of a website that invites visitors to sign up for a newsletter. The sign-up box is small, but the words above it matter: a clearer or more persuasive call to action (CTA) could change how many visitors decide to subscribe.
...
Each visitor either signs up or does not sign up, so each outcome can be represented as a binary variable (1 for sign-up and 0 otherwise):
